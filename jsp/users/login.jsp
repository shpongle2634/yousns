...
body .container .half.bg {
  background-image: url('/yousns/jsp/users/login.jpg');
	            ...
	            <div class="signin-cont cont">
	                <form action="users/auth" method="POST">
	                    <label for="id">Your ID</label>
	                    	<input type="email" name="id" id="id" class="inpt" required="required" placeholder="Your ID(email)">
	        ...
	        <div class="signup-cont cont">
                <form action="users" method="post">
                	...
                	<label for="gender">Your gender</label>					   
    					<input type="radio" name="gender" class="radio" value="0">man
    					<input type="radio" name="gender" class="radio" value="1">woman 
					<div class="submit-wrap">
